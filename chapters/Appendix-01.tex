...
Note that we cannot simply choose the normalization of momentum eigenstates as $\braket{\vec{q}|\vec{p}} = \delta^3(\vec{q} - \vec{p})$, as in nonrelativistic QM, because the delta function alone is not Lorentz-invariant.
