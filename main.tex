...
\usepackage{fontspec}
\newfontfamily\hindifont{Tiro Devanagari Sanskrit}[Script=Devanagari]
...
\colorlet{awesomelinks}{black}
\colorlet{authorhighlight}{black}
...
% \setlength{\cftbeforetoctitleskip}{8cm}
